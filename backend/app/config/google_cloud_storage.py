...
class GoogleCloudStorageConfig:
    ...
    project_name: str = attr.ib(default="morph-and-split-app-490020")

    # Service Account
    service_account_name: str = attr.ib(default="morph-and-split-sa")
    ...
    def __attrs_post_init__(self):
        self.service_account_key_file_path = str(
            os.path.join(current_directory(), self.service_account_key_file_name)
        )
        self.service_account_email = (
            f"{self.service_account_name}@{self.project_name}.iam.gserviceaccount.com"
        )

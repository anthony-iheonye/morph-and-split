...
def serve_train_images_masks():
    try:
        ...
        metadata = []
        for image_name, mask_name in zip(image_files, mask_files):
            image_path = url_for('image_mask_metadata.serve_train_image', filename=image_name, _external=True)
            mask_path = url_for('image_mask_metadata.serve_train_mask', filename=mask_name, _external=True)
...
def get_val_images_masks():
    try:
        ...
        metadata = []
        for image_name, mask_name in zip(image_files, mask_files):
            image_path = url_for('image_mask_metadata.serve_val_image', filename=image_name, _external=True)
            mask_path = url_for('image_mask_metadata.serve_val_mask', filename=mask_name, _external=True)
...
def get_test_images_masks():
    try:
        ...
        metadata = []
        for image_name, mask_name in zip(image_files, mask_files):
            image_path = url_for('image_mask_metadata.serve_test_image', filename=image_name, _external=True)
            mask_path = url_for('image_mask_metadata.serve_test_mask', filename=mask_name, _external=True)
